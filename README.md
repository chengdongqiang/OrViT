...
The OrViT pipeline consists of Perl and Bash scripts, assembled into a Makefile. Makefile has some default options, such as CPU=50, which can be specified by the user.
